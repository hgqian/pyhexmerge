...
"""darkstyle is a dark stylesheet for Python and Qt applications.
...
Then you can get stylesheet provided by darkstyle for various Qt wrappers
as shown bellow

.. code-block:: python

    # PySide
    dark_stylesheet = darkstyle.load_stylesheet_pyside()
    # PyQt4
    dark_stylesheet = darkstyle.load_stylesheet_pyqt()
    # PyQt5
    dark_stylesheet = darkstyle.load_stylesheet_pyqt5()
...
.. code-block:: python
    ...
    # QtPy
    dark_stylesheet = darkstyle.load_stylesheet_from_environment()
    # PyQtGraph
    dark_stylesheet = darkstyle.load_stylesheet_from_environment(is_pyqtgraph)
...
def load_stylesheet(pyside=True):
    ...
    if pyside:
        import darkstyle.pyside_style_rc
    else:
